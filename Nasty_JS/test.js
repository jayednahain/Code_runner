...
//     for (let i = 0; i < nums.length; i++) {
//         let isUnique = true;  // Assume the current element is unique

//         for (let j = 0; j < nums.length; j++) {
//             if (i !== j && nums[i] === nums[j]) {  // Compare with every other element
...
//         if (isUnique) {
//             count++;  // Increment count if the element is unique
//         }
//     }

//     console.log("Number of non-occurrence items:", count);
